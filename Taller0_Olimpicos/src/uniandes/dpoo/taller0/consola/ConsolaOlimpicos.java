...
public class ConsolaOlimpicos
{
	...
	/**
	 * Se crea la función para pedir el nombre del atleta e imprimir los datos del numeral 13. 
	 */
	private void ejecutarPaisPorAtleta()
	{
		System.out.println("\n" + "País de un atleta" + "\n");
		String atleta = input("Ingrese el nombre de un atleta: ");
		String pais = calculadora.paisPorAtleta(atleta);
		if (pais == null)
		{
			System.out.println("No hay un país asociado a este atleta.");
		}
		else
		{
			System.out.println("El país de " + atleta + " es: " + pais);
		}
	}
